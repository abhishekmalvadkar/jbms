...
public class JbmsConfig {
    ...
    public BookmarkService bookmarkService(){
        Bookmark bookmarkOne = new Bookmark("Bookmark 1", "Bookmark 1 url", LocalDate.now(), List.of(new Tag("spring"), new Tag("java"), new Tag("jdbc")));
        Bookmark bookmarkTwo = new Bookmark("Bookmark 2", "Bookmark 2 url", LocalDate.now(), List.of(new Tag("mysql"), new Tag("ssh"), new Tag("jdbc")));
